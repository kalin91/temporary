 ...
 * persisting, retrieving, updating, and deleting order records in the data

    iltering orders by customer, status, or both. It is a part of the repository layer in the application's layered architecture,
 * abstracting the data access logic for the Order domain.
 * </p>
 *
 * <h2>Usage</h2>
 * <pre>{@code
 ...
 * @Autowired
    ...
    rivate OrderRepository orderRepository;
 *
 ...
 * <h2>Return Values</h2>
 * <ul>
 *   <li>Standard CRUD methods return {@code Optional<OrderEntity>}, {@code List<OrderEntity>}, or the entity itself depending on the operation.</li>
