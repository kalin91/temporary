 ...
 *
 * <p>
 * This class reads sample data from JSON files located under
 ...
 *
 * <p>
 * Note: This component is intended for development and demo purposes
...
public class DataSeeder implements CommandLineRunner {
    ...
    public void run(String... args) {
        if (customerRepository.count() == 0) {
            ...
            try {
                ...
                try (InputStream customerStream = new ClassPathResource("data/customers.json").getInputStream()) {
                    customerDataList = objectMapper.readValue(customerStream, new TypeReference<>() {});
                }
                ...
                try (InputStream orderStream = new ClassPathResource("data/orders.json").getInputStream()) {
                    orderDataList = objectMapper.readValue(orderStream, new TypeReference<>() {});
                }
     ...
     *
     * <p>
     * Used only for deserialization and mapping to {@link CustomerEntity}.
     */
    @Data
